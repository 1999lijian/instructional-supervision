    ...
    <div class="row">
        ...
        <div class="col-10 rounded-div">
            ...
            <form id="optionUpDate">
                ...
                <input type="hidden" name="optionId" value="${optionUpDate.optionId}">


                <!-- 教学名称 -->
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">问题</span>
                    <input type="text" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-default" id="scoreName" name="scoreName"
                           value="${optionUpDate.scores.scoreName}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-default" id="optionName" name="optionName"
                           value="${optionUpDate.optionName}">
                </div>
...
<script>
    ...
    function updateButton() {
        var form = $("#optionUpDate");
        //将数据
        var formData = form.serialize();

        $.ajax({
            url: "/supervision/updateEvaluateName",
            type: "POST",
            data: formData,
