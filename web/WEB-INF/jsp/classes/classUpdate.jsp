...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-10 rounded-div">
            <form id="UpDate">
                <input type="hidden" name="CIId" value="${classesByCIName.CIId}">
                <!-- 教学名称 -->
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">班级名称</span>
                    <input type="text" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-default" id="CIName" name="CIName"
                           value="${classesByCIName.CIName}">
                </div>
                <!-- 提交/取消 -->
