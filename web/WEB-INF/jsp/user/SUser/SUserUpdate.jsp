...
<div class="row">
    ...
    <div class="col-10 rounded-div">
        <div class="table-responsive">
            <%--                修改用户 用form表单进行提交--%>
            <form id="updateData">
                <input type="hidden" name="SId" value="${updateSUserdata.SId}">
                <input type="hidden" name="suid" value="${updateSUserdata.suid}">
                <div class="form">
                    <label>密码</label>
                    <input type="text" class="form-control"
                           name="UUser.UPassword"
                           id="uPassword"
                           value="${updateSUserdata.UUser.UPassword}"
                    >
                ...
                <div class="form">
                    ...
                    <select class="form-control" name="SSex">
                        <option value="1" ${updateSUserdata.SSex == 0 ? 'selected' : ''}>男</option>
                        <option value="2" ${updateSUserdata.SSex   == 1 ? 'selected' : ''}>女</option>
                    </select>
                </div>
                ...
                <div class="form">
                    ...
                    <input name="SDate" type="date" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-default" value="${updateSUserdata.SDate}">
                </div>


                <div class="form">
                    <label>所属学院</label>
                    <select class="form-control" name="SCollegeNo" id="SCollegeNo">
        ...
        <div class="modal-footer">
            ...
            <a type="button" class="btn btn-primary" href="/supervision/findAllSUser">取消</a>
        </div>
...
<script>
    ...
    //    查询所有学院
    var SCollegeNo = ${updateSUserdata.SCollegeNo};
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (index, college) {
                    ...
                    if (SCollegeNo == college.collegeId) {
