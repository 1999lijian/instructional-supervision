    ...
    <div class="row ">
        ...
        <div class="col-10 rounded-div">
            <form id="messageUpDate">
                <%--                留言ID--%>
                <input type="hidden" name="messageReplyId" value="${Date.messageId}">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-default"
                           value="${Date.messageName}" readonly>
                </div>

                <%--回复留言--%>
                <div class="input-group mb-3">
                    <span class="input-group-text">受教教师回复留言</span>
                    <input type="text" class="form-control" aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-default" id="messageReply" name="messageReply"
                    >
                </div>
...
<script>
    ...
    function updateButton() {
        ...
        $.ajax({
            url: "/supervision/UpMessageReplyDate",
            type: "POST",
            data: formData,
