...
public interface CourseMapper {
    ...
    //    分页
    List<Course> findAllCourseList(@Param("startIndex") int startIndex,
    ...
    //检查是否有评价信息
    int checkCourseEvaluateById(@Param("evaluationCourse") int evaluationCourse,
                                @Param("evaluationUser") int evaluationUser);

    //    教师检查是否有评价信息数据可视化
    int checkCourseEvaluateByTId(@Param("evaluationCourse") int evaluationCourse);
    ...
    //查询是否存储听课评价
    int findCourseListen(@Param("listencordsCords") int listencordsCords,
                         @Param("listencordsUserId") int listencordsUserId);

    //查询是否存储听课评价 课程
    int findCourseListenT(@Param("listencordsCords") int listencordsCords);
    ...
    //    检查是否有回复留言
    int findMessageReplyAll(int messageId);
    ...
    //    统计学生评价总人数
//    参数是课程ID
    int findStatisticsSUserEvaluateAll(int cId);

    //    统计学生已评价总人数
    int findStatisticsSUserEvaluateReviewed(int cId);
    ...
    //检查是否有巡查课程记录
    int checkCourseTourList(@Param("tourClassCourse") int tourClassCourse);
